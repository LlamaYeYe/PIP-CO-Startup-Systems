(function() {
   ...
   */
  const STARTUPS = [
    { file: "MISTER.AVI",         label: "Mister Handy",               cat: "special", fade: 6250,  hard: 9765  },
    { file: "VAULTGIRL.AVI",      label: "Vault Girl",                 cat: "special", fade: 3500,  hard: 7015  },
    { file: "DEATHCLAW.AVI",      label: "Deathclaw Vault Experiment", cat: "special", fade: 3500,  hard: 7015  },
    { file: "YESMAN.AVI",         label: "YES MAN",                    cat: "npc",     fade: 4917,  hard: 8432  },
    ...
    { file: "MINUTEMEN.AVI",      label: "The Minutemen",              cat: "faction", fade: 5500,  hard: 9015  },
      ...
      return new Promise(function(done) {
        ...
        function play() {
          ...
          function startVideo() {
            ...
            b = setTimeout(function() { end("fade"); }, fm(n) + (n === 8 ? 420 : 180));
          }
        ...
        try {
          ...
          d = setTimeout(function() { end("hard-failsafe"); }, hm(n));
        } catch (e) {

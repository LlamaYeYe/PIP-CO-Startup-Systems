...
let c=0,s=0,t,page=0,ic=[0,0,0,0,0,0,0,0,0];
...
function ex(p){return !!fs.statSync(p);}
function sel(){
try{
...
function vf(n){
switch(n){
case 0:return B+"MISTER.AVI";
case 1:return B+"VAULTGIRL.AVI";
case 2:return B+"DEATHCLAW.AVI";
case 3:return B+"YESMAN.AVI";
case 4:return B+"ENCLAVE.AVI";
case 5:return B+"BOS.AVI";
case 6:return B+"MOTHMAN.AVI";
case 7:return B+"MINUTEMEN.AVI";
case 8:return B+"ENCLAVE_PIPBOY.AVI";
}
}
function af(n){
switch(n){
case 0:return B+"MISTER.WAV";
case 1:return B+"VAULTGIRL.WAV";
case 2:return B+"DEATHCLAW.WAV";
case 3:return B+"YES MAN.WAV";
case 4:return B+"THE ENCLAVE.WAV";
case 5:return B+"BOS.WAV";
case 6:return B+"MOTHMAN.WAV";
case 7:return B+"MINUTEMEN.WAV";
case 8:return B+"ENCLAVE_PIPBOY.WAV";
}
}
function fm(n){
if(n===8)return 25500;
...
if(n===8){
e=setTimeout(function(){e=undefined;startVideo();},260);
return;
}
startVideo();
}
...
function installed(n){return n>=0&&n<9&&ic[n];}
